...
import {addFavorite, favoriteData, setLocalStorageFavorite,deleteFavorite} from "./favorite.js";
import {addBasket,deleteBasket,getBasket,basketData} from "./basket.js";
...
const getShoes = () => {
  ...
  fetch(
    ...
    .then((resolve) => {
      viewContent(resolve, shoesList,getShoes)
    })
    .catch((err) => alert(err));
